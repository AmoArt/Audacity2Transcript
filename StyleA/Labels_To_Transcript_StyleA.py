...
txtStart = """This is a 'Labels to Transcript, convertor for the use with the basic audacity labels\n
...
try:
    ...
    f = open("OUTPUT_Filelist_A.txt", "w")
    ...
    #        #places the filename and transcript in the correct positions
        line = re.sub(r'(^.*?$)', r'wavs/\g<1>.wav|\g<1>;', line)
